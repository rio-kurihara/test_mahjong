...
def make_image_message():
    messages = ImageSendMessage(
        original_content_url="https://test-mahjong.herokuapp.com/static/test.png", #JPEG 最大画像サイズ：240×240 最大ファイルサイズ：1MB(注意:仕様が変わっていた)
        preview_image_url="https://test-mahjong.herokuapp.com/static/test.png" #JPEG 最大画像サイズ：1024×1024 最大ファイルサイズ：1MB(注意:仕様が変わっていた)
    )
    return messages
